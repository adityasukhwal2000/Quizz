...
<!-- <input class="main_button" type="submit" value="Play" style="display: none;" /> -->
    ...
    <centre>
            <p class=" error1p" style="border-radius: 20%;
                                       width : parent;
        color: white;
        font-size:18px; 
        margin: 10px;
        background-color: #ff1e50;
        padding: 8px;"> Maximum Attempt Reached, Failed to Login !<br></p></centre><br>
   <b> <a href="dftry.php" style="border-radius: 15%;
                                       width : parent;
        color: white;
        font-size:18px; 
        margin: 10px;
       ...
       text-decoration: none;
       padding: 12px;">Back to Homepage</a></b>
