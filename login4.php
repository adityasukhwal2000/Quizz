...
$pass_check1=$_POST['pass2'];
$pass_check2=$_POST['pass3'];
        ...
        padding: 8px;"> Incorrect Username or Password !<br></p></centre>
            ...
            <form method="POST"  action="login5.php">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="pass4" id="pass4" class="form-control" placeholder="Password">
                </div>
                <div class="form-group">

                    <input type="hidden" name="pass3" id="pass3" class="form-control" value="">
                
                
                </div>
                <input type="hidden" id="pass3" value="">
...
<a href="login.php"><button id = "wrong"type="button">wrong</button></a>-->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            pass2 = "<?php echo $_POST['pass3']; ?>";
            document.getElementById("pass3").value= pass2;
            var chkpass1 = document.getElementById("pass3").value;
           // alert(" pass3 : " + chkpass1);
