...
<div class="d-flex flex-row flex_main" style="margin-top: 10px;">
  ...
  <div class="p-2 flex-fill justify-content-center"> 3</div>
    ...
    <div class="p-2 flex-fill justify-content-center" style="background-color: #ffffcc; color: #ff1e50; border-radius: 80%; "> 7</div>
    ...
    <div class="p-2 flex-fill justify-content-center"> 10</div>
        ...
        <div class="content" style="border-radius: 50%; margin: 10px;">
            <div class="yellow-strip">
                 <b>Que 7)</b> Which Indian cricketer had won the “Man of the Match” award in the final of the ICC World Cup 1983? <br><br>
             <div style="text-align:center;">
                 <form action="question8.php" method="post" id="form">
                <button type="submit" style="background-color: #21aaff; font-size: 17px;padding: 5px; padding-left 20px; border-radius: 20%; color: white;" onclick="save(1)" id="option1" > Anil Kumble </button> 
                <button type="submit" style="background-color: #21aaff; font-size: 17px;padding: 5px; padding-left 20px; border-radius: 20%; color: white;" onclick="save(2)"  id="option2"> Sunil Gavaskar </button>
                <button type="submit" style="background-color: #21aaff; font-size: 17px;padding: 5px; padding-left 20px; border-radius: 20%; color: white;" onclick="save(3)" id="option3"> Kapil Dev </button>
                <button type="submit" style="background-color: #21aaff; font-size: 17px;padding: 5px; padding-left 20px; border-radius: 20%; color: white;" onclick="save(4)" id="option4"> Mohinder Amarnath </button>
