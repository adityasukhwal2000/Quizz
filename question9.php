...
<div class="d-flex flex-row flex_main" style="margin-top: 10px;">
  ...
  <div class="p-2 flex-fill justify-content-center"> 3</div>
    ...
    <div class="p-2 flex-fill justify-content-center " style="background-color: #ffffcc; color: #ff1e50; border-radius: 80%; "> 9</div>
    <div class="p-2 flex-fill justify-content-center"> 10</div>
        ...
        <div class="content" style="border-radius: 50%; margin: 10px;">
            <div class="yellow-strip">
                  <b>Que 9)</b> Which cricketer has scored the most ducks at the World Cup? <br><br>
             <div style="text-align:center;">
                 <form action="question10.php" method="post" id="form">
                <button type="submit" style="background-color: #21aaff; font-size: 17px;padding: 5px; padding-left 20px; border-radius: 20%; color: white;" onclick="save(1)" id="option1" > Ajit Agarkar </button> 
                <button type="submit" style="background-color: #21aaff; font-size: 17px;padding: 5px; padding-left 20px; border-radius: 20%; color: white;" onclick="save(2)"  id="option2"> K. Srikanth </button>
                <button type="submit" style="background-color: #21aaff; font-size: 17px;padding: 5px; padding-left 20px; border-radius: 20%; color: white;" onclick="save(3)" id="option3"> Ajay Jadeja </button>
                <button type="submit" style="background-color: #21aaff; font-size: 17px;padding: 5px; padding-left 20px; border-radius: 20%; color: white;" onclick="save(4)" id="option4"> Gundappa </button>
