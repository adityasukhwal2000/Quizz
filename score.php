...
<div class="box">
<center>
<h1 class="title"> Your Score : <?php echo $_POST['id']; ?> <br>Thanks for playing this quiz !<br></h1>
<div class="small_box">
...
<a href="login.php" >
    <input type="submit" class="main_button" id="btnClick" value="Restart Quiz" onclick="CountFun()";/></a>
